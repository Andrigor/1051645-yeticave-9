<main>
    ...
    <form enctype="multipart/form-data" class="form form--add-lot container form--invalid" action="/add.php" method="post">
        <!-- form--invalid -->
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small">
                ...
                <input id="lot-rate" type="text" name="lot[start_price]" placeholder="0">
            ...
            <div class="form__item">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="lot[closed_at]"
